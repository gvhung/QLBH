...
%>
<li>
    <%: Html.ActionLink("Khách hàng", "Index", "Customer")%></li>
<li>
    <%: Html.ActionLink("Thống kê", "OrderManager", "Customer")%></li>
<%
    }
...
%>
<li>
    <%: Html.ActionLink("Seller", "SaleList", "Sale")%></li>
<li>
    <%: Html.ActionLink("Khách hàng", "CustomerList", "Sale")%></li>
<%
    }
...
%>
<li>
    <%: Html.ActionLink("Bán hàng", "SaleManager", "Manager")%></li>
<li>
    <%: Html.ActionLink("Công nợ", "PaymentManager", "Manager")%></li>
<%
    }
%>
